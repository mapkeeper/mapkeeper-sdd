"""Alembic migration environment for the MapKeeper PostgreSQL schema."""
...
from mapkeeper.models import Base
...
async def run_async_migrations() -> None:
    """Create the async engine and run migrations inside one connection."""
